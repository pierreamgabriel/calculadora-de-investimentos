...
function calculate() {
	...
	const result = (parseInt(choices.amount) * Math.pow(1 + (parseFloat(choices.ipca) + parseFloat(choices.rates))/100, parseInt(choices.months)/12)) - parseInt(choices.amount);
